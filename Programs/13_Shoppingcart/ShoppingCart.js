...
function subtract_selection(x) {
    if (quantities[x] > 0) {
        ...
        // Handle the error here, such as displaying an alert message or disabling the subtract button
...
document.getElementById("checkout").addEventListener("click", function() {
    if (totalOrderAmt > 0) {
        ...
        // Handle the error here, such as displaying an alert message or disabling the checkout button
